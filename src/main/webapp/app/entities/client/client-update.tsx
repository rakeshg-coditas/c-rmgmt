    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="cRmgmtApp.client.home.createOrEditLabel">Create or edit a Client</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
              ...
              <AvForm model={isNew ? {} : clientEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField
                    ...
                    validate={{
                      required: { value: true, errorMessage: 'This field is required.' },
                      pattern: { value: '^(.+)@(.+)$', errorMessage: "This field should follow pattern for '^(.+)@(.+).." }
                    }}
                  />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label id="isActiveLabel" check>
                    <AvInput id="client-isActive" type="checkbox" className="form-control" name="isActive" />
                    Is Active
                  </Label>
                </AvGroup>
