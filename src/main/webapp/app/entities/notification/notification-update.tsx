    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="cRmgmtApp.notification.home.createOrEditLabel">Create or edit a Notification</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : notificationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="toLabel" for="notification-to">
                    To
                  </Label>
                  <AvField id="notification-to" type="text" name="to" />
                </AvGroup>
                <AvGroup>
                  <Label id="fromLabel" for="notification-from">
                    From
                  </Label>
                  <AvField id="notification-from" type="text" name="from" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label id="isReadLabel" check>
                    <AvInput id="notification-isRead" type="checkbox" className="form-control" name="isRead" />
                    Is Read
                  </Label>
                </AvGroup>
